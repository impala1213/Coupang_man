...
public class CreepyCatTestB : MonoBehaviour {
    ...
    void EndAnim()
    {
         TweenRX.Add(myObject, moveTimeB, -90.0f).Relative().Then(StartAnim);
    }

    void StartAnim()
    {
        TweenRX.Add(myObject, moveTimeB, 90.0f).Relative().Then(EndAnim);
