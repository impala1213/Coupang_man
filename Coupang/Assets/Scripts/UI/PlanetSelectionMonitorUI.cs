...
public class PlanetSelectionMonitorUI : MonoBehaviour
{
    ...
    // Safety net: if PlanetSelectionState doesn't raise events for some reason (script execution order, etc.),
    // we still refresh when candidates appear/disappear.
    ...
    private void OnEnable()
    {
        ...
        // IMPORTANT: candidates are generated by PlanetSelectionBootstrapper at ship-scene startup.
        LoadFromState();
        RefreshUI();
    ...
    private void RefreshUI()
    {
        ...
        if (!hasCandidates)
        {
            // Avoid showing "(None)" on boot; candidates will arrive via PlanetSelectionBootstrapper.
        ...
        // - Primary line: Reward
        // - Secondary line: planet type (optional separate TMP)
